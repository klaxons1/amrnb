...
/* Ported 1:1 from opencore-amr 0.1.6 (d_gain_p.cpp, d_gain_c.cpp, dec_gain.cpp, dec_lag3.cpp, dec_lag6.cpp) via the JS reference port. The class and member names
