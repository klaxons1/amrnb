...
/* Ported 1:1 from opencore-amr 0.1.6 (basic_op_c_equivalent.h, basic_op.h, negate.cpp, add.cpp, sub.cpp, shr.cpp, mult_r.cpp, round.cpp, shr_r.cpp, div_s.cpp, l_shr_r.cpp, norm_l.cpp, norm_s.cpp, extract_h.cpp, extract_l.cpp, l_deposit_h.cpp, l_deposit_l.cpp) via the JS reference port. The class and member names
