...
public final class DPlsf {
    ...
    public static final class State {
        ...
        public int reset() {
            ...
            System.arraycopy(Tbls.mean_lsf_5, 0, past_lsf_q, 0, Cnst.M);
            return 0;
        }
    }
    ...
    public static void Init_D_plsf_3(State st, int index) {
        System.arraycopy(Tbls.past_rq_init, index * Cnst.M, st.past_r_q, 0, Cnst.M);
    }
    ...
    public static void D_plsf_3(State st, int mode, int bfi, short[] indice, int indiceOff,
        ...
        if (bfi != 0) {
            ...
            for (int i = 0; i < Cnst.M; i++) {
                ...
                index = Basicop.mult(Tbls.mean_lsf_3[i], ONE_ALPHA, pOverflow);
            ...
            if (mode != Cnst.MRDTX) {
                for (int i = 0; i < Cnst.M; i++) {
                    temp = Basicop.mult(st.past_r_q[i], Tbls.pred_fac_3[i], pOverflow);
                    temp = Basicop.add_16(Tbls.mean_lsf_3[i], temp, pOverflow);
                    st.past_r_q[i] = (short) Basicop.sub(lsf1_q[i], temp, pOverflow);
                }
            } else {
                for (int i = 0; i < Cnst.M; i++) {
                    temp = Basicop.add_16(Tbls.mean_lsf_3[i], st.past_r_q[i], pOverflow);
                    st.past_r_q[i] = (short) Basicop.sub(lsf1_q[i], temp, pOverflow);
                }
            }
        } else {
            ...
            short[] p_cb1;
            short[] p_cb3;
            final short[] p_cb2 = Tbls.dico2_lsf_3;

            if (mode == Cnst.MR475 || mode == Cnst.MR515) {
                p_cb1 = Tbls.dico1_lsf_3;
                p_cb3 = Tbls.mr515_3_lsf;
                index_limit_1 = (DICO1_SIZE - 1) * 3;
                index_limit_3 = (MR515_3_SIZE - 1) * 4;
            } else if (mode == Cnst.MR795) {
                p_cb1 = Tbls.mr795_1_lsf;
                p_cb3 = Tbls.dico3_lsf_3;
    ...
    public static void D_plsf_5(State st, int bfi, short[] indice, int indiceOff,
        ...
        if (bfi != 0) {
            ...
            lsf1_r[0] = Tbls.dico1_lsf_5[temp];
            lsf1_r[1] = Tbls.dico1_lsf_5[temp + 1];
            lsf2_r[0] = Tbls.dico1_lsf_5[temp + 2];
            lsf2_r[1] = Tbls.dico1_lsf_5[temp + 3];

            temp = Basicop.shl(indice[indiceOff + 1], 2, pOverflow);
            lsf1_r[2] = Tbls.dico2_lsf_5[temp];
            lsf1_r[3] = Tbls.dico2_lsf_5[temp + 1];
            lsf2_r[2] = Tbls.dico2_lsf_5[temp + 2];
            lsf2_r[3] = Tbls.dico2_lsf_5[temp + 3];
            ...
            if (sign == 0) {
                lsf1_r[4] = Tbls.dico3_lsf_5[temp];
                lsf1_r[5] = Tbls.dico3_lsf_5[temp + 1];
                lsf2_r[4] = Tbls.dico3_lsf_5[temp + 2];
                lsf2_r[5] = Tbls.dico3_lsf_5[temp + 3];
            } else {
                lsf1_r[4] = (short) Basicop.negate(Tbls.dico3_lsf_5[temp]);
                lsf1_r[5] = (short) Basicop.negate(Tbls.dico3_lsf_5[temp + 1]);
                lsf2_r[4] = (short) Basicop.negate(Tbls.dico3_lsf_5[temp + 2]);
                lsf2_r[5] = (short) Basicop.negate(Tbls.dico3_lsf_5[temp + 3]);
            }

            temp = Basicop.shl(indice[indiceOff + 3], 2, pOverflow);
            lsf1_r[6] = Tbls.dico4_lsf_5[temp];
            lsf1_r[7] = Tbls.dico4_lsf_5[temp + 1];
            lsf2_r[6] = Tbls.dico4_lsf_5[temp + 2];
            lsf2_r[7] = Tbls.dico4_lsf_5[temp + 3];

            temp = Basicop.shl(indice[indiceOff + 4], 2, pOverflow);
            lsf1_r[8] = Tbls.dico5_lsf_5[temp];
            lsf1_r[9] = Tbls.dico5_lsf_5[temp + 1];
            lsf2_r[8] = Tbls.dico5_lsf_5[temp + 2];
            lsf2_r[9] = Tbls.dico5_lsf_5[temp + 3];
