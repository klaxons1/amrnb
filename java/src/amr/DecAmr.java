...
public final class DecAmr {
    ...
    public static final short[][] BITNO = {
        Tbls.bitno_MR475, Tbls.bitno_MR515, Tbls.bitno_MR59, Tbls.bitno_MR67,
        Tbls.bitno_MR74, Tbls.bitno_MR795, Tbls.bitno_MR102, Tbls.bitno_MR122,
        Tbls.bitno_MRDTX,
    };
    ...
    public static void Decoder_amr(State st, int mode, short[] parm, int parmOff, int frame_type,
        ...
        if (frame_type == Cnst.RX_SPEECH_BAD || frame_type == Cnst.RX_NO_DATA
            ...
            if (frame_type == Cnst.RX_NO_DATA || frame_type == Cnst.RX_ONSET) {
                PostPre.build_CN_param(st.nodataSeed, Tbls.prmno[mode], BITNO[mode],
