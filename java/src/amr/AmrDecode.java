...
public final class AmrDecode {
    ...
    public static void wmf_to_ets(int frame_type_3gpp, byte[] wmf_input, int wmfOff, short[] ets_output) {
        ...
        if (frame_type_3gpp < Cnst.AMR_SID) {
            ...
            for (int i = Tbls.numOfBits[frame_type_3gpp] - 1; i >= 0; i--) {
    ...
    public static final short[][] REORDER_BITS = {
        Tbls.reorderBits_MR475, Tbls.reorderBits_MR515, Tbls.reorderBits_MR59,
        Tbls.reorderBits_MR67, Tbls.reorderBits_MR74, Tbls.reorderBits_MR795,
        Tbls.reorderBits_MR102, Tbls.reorderBits_MR122,
    };
    ...
    public static int AMRDecode(SpDec.State decoder_state, int frame_type,
        ...
        byte_offset = Tbls.WmfDecBytesPerFrame[frame_type];
